  ...
  return (
    <main className="page">
      <section className="hero">
        ...
        <p className="sub">
          Enterprise blockchain infrastructure for the Lux Network ecosystem.
        ...
        <div className="actions">
          ...
          <a href="https://docs.lux.network" className="btn">View Documentation</a>
        </div>
      </section>

      <section className="grid">
        <h2>Everything you need to build Web3</h2>
        <p>From RPC endpoints to account abstraction, Lux Cloud provides the complete infrastructure stack for blockchain developers.</p>
        <div className="cards">
          {FEATURES.map((f) => (
