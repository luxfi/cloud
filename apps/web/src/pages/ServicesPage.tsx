const SERVICES = [
  ...
  { name: 'Node Hosting',    desc: 'Validators, archive nodes, RPC, bootnodes. Managed or self-hosted on Lux DOKS.' },
  { name: 'Bridges',         desc: 'Native and wrapped cross-chain transfers via Lux Bridge.' },
  { name: 'DEX + AMM',       desc: 'Spot, orderbook, and automated market making on Lux Exchange.' },
  { name: 'Chain Launch',    desc: 'One-click L1/L2 rollup deployment with Lux consensus + post-quantum security.' },
